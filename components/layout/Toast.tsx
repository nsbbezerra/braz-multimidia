    ...
    >
      <div
        className={`w-[80vw] max-w-sm relative p-5 ${
          (scheme === "info" &&
            "bg-sky-700 text-white bg-opacity-95 backdrop-blur-sm") ||
          (scheme === "success" &&
            "bg-green-700 text-white bg-opacity-95 backdrop-blur-sm") ||
          (scheme === "warning" &&
            "bg-yellow-600 text-white bg-opacity-95 backdrop-blur-sm") ||
          (scheme === "error" &&
            "bg-red-600 text-white bg-opacity-95 backdrop-blur-sm")
